...
export const deleteUser = async (req, res) => {
    try {
        ...
        await transporter.sendMail({
            to: user.email,
            subject: 'Confirmación eliminación de ADMIN — Gestión Restaurante',
            html: renderEmailTemplate({
                title: 'Confirma eliminación de ADMIN',
                preheader: 'Verifica la eliminación del usuario administrador.',
                heading: 'Confirmación requerida',
                intro: 'Recibimos una solicitud para eliminar un administrador del sistema. Confirma la acción desde el siguiente enlace.',
                paragraphs: [
                    'Si tú solicitaste esta eliminación, pulsa el botón para confirmar. De lo contrario, ignora este correo y no se realizará ningún cambio.',
                ],
                buttonText: 'Confirmar eliminación',
                buttonUrl: deleteLink,
                fallbackText: 'Si el botón no funciona, copia y pega este enlace en tu navegador:',
                fallbackUrl: deleteLink,
                notice: 'Este enlace es de un solo uso y protege al sistema de cambios no autorizados.'
            })
        });
