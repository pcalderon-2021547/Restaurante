...
/**
 * Encabezado ornamental del modulo de auth. Version movil (columna
 * unica) del panel izquierdo "auth-left" de la web: marca + rayita
 * dorada + tagline. En pantallas angostas no hay espacio para el
 * layout de dos columnas del original, asi que se apila todo arriba
 * de la tarjeta de formulario, preservando color/tipografia/tono.
 */
