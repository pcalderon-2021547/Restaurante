...
const StarDisplay = ({ rating }) => (
    <span className="flex gap-0.5">
        {[1, 2, 3, 4, 5].map((star) => (
            <span key={star} className="text-sm" style={{ color: star <= rating ? "#c9a84c" : "#3a3328" }}>★</span>
        ))}
    </span>
);
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mb-8">
                ...
                <button
                    onClick={() => { setSelectedReview(null); setOpenModal(true); }}
            ...
            <div className="flex gap-3 items-end mb-6 p-4 rounded-xl"
                style={{ background: "#1c1a16", border: "1px solid rgba(201,168,76,0.15)" }}>
                ...
                {selectedRestaurant && (
                    <div className="text-xs px-3 py-2 rounded-lg self-end"
                        style={{ background: "rgba(201,168,76,0.08)", color: "#5a5040", border: "1px solid rgba(201,168,76,0.15)", whiteSpace: "nowrap" }}>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-16" style={{ color: "#3a3328" }}>
                        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem" }}>
                            Selecciona un restaurante para ver sus reseñas
                        </p>
                    </div>
                ) : reviews.length === 0 ? (
                    <div className="text-center py-16" style={{ color: "#3a3328" }}>
                        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.3rem" }}>
                            Este restaurante no tiene reseñas
                        </p>
                    ...
                    reviews.map((review, index) => (
                        <div key={review._id}
                            ...
                            <span className="col-span-2"><StarDisplay rating={review.rating} /></span>
 
                            <span className="col-span-4 text-sm truncate pr-4" style={{ color: "#9a8e74" }} title={review.comment}>
            ...
            <ReviewModal
                isOpen={openModal}
                onClose={() => { setOpenModal(false); setSelectedReview(null); }}
